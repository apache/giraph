...
/**
 * Creates random edges when we merge multiple super-community graphs
 * into one big graph.
 */
public class MergeCreateRandomEdges extends
  ...
  private static final Logger LOG =
      Logger.getLogger(MergeCreateRandomEdges.class);
   ...
   */
  public MergeCreateRandomEdges(ObjectTransfer<LongWritable> target,
  ...
  public VertexSender<LongWritable, VertexData, NullWritable> getVertexSender(
    ...
    return new VertexSender<LongWritable, VertexData, NullWritable>() {
      ...
      public void vertexSend(Vertex<LongWritable,
        ...
        int remainingDegree = vertex.getValue().getDesiredDegree() -
