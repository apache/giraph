...
public class DiffusionVertexInputFormat
    extends TextVertexInputFormat<LongWritable, DiffusionVertexValue, NullWritable> {

  @Override
  public TextVertexReader createVertexReader(InputSplit arg0, TaskAttemptContext arg1)
      throws IOException {
  ...
  protected class DiffusionVertexReader extends TextVertexReaderFromEachLine {
    ...
    protected Iterable<Edge<LongWritable, NullWritable>> getEdges(Text line) throws IOException {
      ...
      for (i = 0; i < edgeArray.length; ++i) {
        ...
        edges.add(EdgeFactory.create(new LongWritable(neighborId), NullWritable.get()));
      }
      return edges;
    }
