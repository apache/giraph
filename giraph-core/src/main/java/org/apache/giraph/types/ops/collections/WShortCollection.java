 ...
 */
public interface WShortCollection
    extends WCollection<ShortWritable>, ShortCollection {
  /**
   ...
   */
  void forEachShort(ShortConsumer f);
   ...
   */
  boolean forEachWhileShort(ShortPredicate f);
}
