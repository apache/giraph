...
public class FixedCapacityIntByteMinHeap
   ...
   */
  public boolean forEachWhileIntByte(IntBytePredicate f) {
    for (int i = 0; i < size(); ++i) {
  ...
  /** Iterator for FixedCapacityIntByteMinHeap */
  private class IteratorImpl implements ObjectIterator<Int2ByteMap.Entry> {
    /** Reusable entry */
  ...
  private static class MutableEntry extends AbstractInt2ByteMap.BasicEntry {
    /** Default constructor */
