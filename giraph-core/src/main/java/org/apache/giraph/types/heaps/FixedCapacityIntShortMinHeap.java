...
import org.apache.giraph.function.primitive.pairs.IntShortConsumer;
import org.apache.giraph.function.primitive.pairs.IntShortPredicate;

// AUTO-GENERATED class via class:
// org.apache.giraph.generate.GeneratePrimitiveClasses

/**
 * Min heap which holds (int key, short value) pairs with
 ...
 */
public class FixedCapacityIntShortMinHeap
   ...
   */
  public FixedCapacityIntShortMinHeap(int capacity) {
   ...
   */
  protected int compare(int key1, short value1,
      int key2, short value2) {
   ...
   */
  public static void write(FixedCapacityIntShortMinHeap heap,
   ...
   * @param in   Data input
   * @return FixedCapacityIntShortMinHeap deserialized from data input.
   * @throws IOException
   */
  public static FixedCapacityIntShortMinHeap read(
      FixedCapacityIntShortMinHeap heap, DataInput in)
      throws IOException {
    int capacity = in.readInt();
    if (heap == null || heap.capacity != capacity) {
      heap = new FixedCapacityIntShortMinHeap(capacity);
    } else {
      heap.clear();
    }
   ...
   */
  private int removeRootAndFindPosition(int key, short value) {
    int position = 0;
    while (position < size) {
      // Find the left child
   ...
   */
  public void forEachIntShort(IntShortConsumer f) {
   ...
   */
  public boolean forEachWhileIntShort(IntShortPredicate f) {
    for (int i = 0; i < size(); ++i) {
  ...
  /** Iterator for FixedCapacityIntShortMinHeap */
  private class IteratorImpl implements ObjectIterator<Int2ShortMap.Entry> {
    /** Reusable entry */
  ...
  private static class MutableEntry extends AbstractInt2ShortMap.BasicEntry {
    /** Default constructor */
