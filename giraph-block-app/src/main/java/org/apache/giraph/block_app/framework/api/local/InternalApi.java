...
class InternalApi<I extends WritableComparable, V extends Writable,
  ...
  public Iterable<I> getPartitionDestinationVertices(int partitionId) {
    if (previousMessages != null) {
      Iterable result = previousMessages.getPartitionDestinationVertices(partitionId);
      if (result != null) {
        return result;
      }
    }
  ...
  public void afterMasterBeforeWorker(BlockWorkerPieces computation) {
    ...
    for (Map.Entry<I, VertexMutations<I, V, E>> entry : mutations.entrySet()) {
      ...
      Vertex<I, V, E> vertex = vertexResolver.resolve(
        ...
        originalVertex,
        curMutations,
        !ignoreExistingVertices && previousMessages != null && previousMessages.hasMessage(vertexIndex)
      );
    ...
    if (!ignoreExistingVertices && createVertexOnMsgs && previousMessages != null) {
  ...
  public boolean ignoreExistingVertices() {
    return previousMessageClasses != null && previousMessageClasses.ignoreExistingVertices();
  }
